...
class PTPForeignMaster:
    ...
    def checkMasterQuality(self):
        # TODO: Verify the quality of the Master's announce timing. Not needed at receiver.
        ...
        AInterval03 = AInterval * 0.3
        isWithin = ((AInterval - AInterval03) < ArithMean and ArithMean < (AInterval + AInterval03))
        # i.e. within ±30%
