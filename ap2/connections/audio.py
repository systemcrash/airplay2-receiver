            ...
            while True:
                ...
                if rtspconn.poll(0):
                    ...
                    if str.startswith(message, "flush_seq_rtptime"):
                        ...
                        self.rtp_buffer.flush(currentTS)
                    ...
                    try:
                        ...
                        if rtp:
                            if p_write_a:
                                ...
                                '''
                                if delay < ((2 * -one_pkt)):
                                    """ What to do here depends on the receiver performance. 'continue' too often sounds crunchy.
                                    dont skip frames and the playout lags behind. This is an unbuffered approach. """
                                    continue
                                '''
                                if delay - 2 > 3:
                                ...
                                if rtp.sequence_no % 20 == 0:
                                    print(f'playout offset: {delay:+3.2} msec (local reference)', end='\r', flush=False)
            ...
            if playing and buffer_ready:
                ...
                if rtp:
                    if p_write_a:
                        ...
                        if i % 20 == 0:
                            print(f'playout offset: {msec_to_playout:+3.2} msec (local reference)     ', end='\r', flush=False)
